...
class LanguagesControllerTest < ActionController::TestCase
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post :create, language: { description: @language.description, name: @language.name, origin: @language.origin }
    end
  ...
  test "should update language" do
    put :update, id: @language, language: { description: @language.description, name: @language.name, origin: @language.origin }
    assert_redirected_to language_path(assigns(:language))
  end
